...
using Pharmacie.Code;
using umbraco.BusinessLogic;
using umbraco.cms.businesslogic.member;

namespace Pharmacie.Controllers.SurfaceControllers
{
    public class AuthSurfaceController : SurfaceController
    {
        ...
        public ActionResult HandleLogin(LoginViewModel model)
        {
            ...
            try
            {
                ...
                var attemptLogin = Member.GetMemberFromLoginNameAndPassword(model.EmailAddress, model.Password);
